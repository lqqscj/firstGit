...
<html>
  ...
  <div class="right">
	  <div class="admin">
	    ...
	    <table>
	    	<tr><td>登录帐号：</td><td><input id="manager_id" name="manager_id" autocomplete="off" maxlength="10" type="text"/></td><td id="err_manager_id"></td></tr>
   ...
   function startPost(){
	   ...
	   var lens=[3,2,6,6];
	   var msg=["请输入登录帐号，至少3位。","请输入真实姓名，至少2位。","请输入登录密码，至少6位。","请输入确认密码，至少6位。"];
	   var flag=true;
