...
<html>
  ...
  <body>
  <div class="login-title" style="color:red">学生信息管理系统<small>登录</small></div>
  <div class="login-main">
  		<div class="login-box">
  			<div class="box" style="color:red">
  				<h2>用户登录</h2>
  				<form action="loginServlet" method="post" id="frm">
  				<p><label>帐号：</label><input type="text" name="manager_id" id="manager_id"></p>
